...
void conv2(DataType inp_img[INP_IMAGE_SIZE * INP_IMAGE_SIZE * INP_IMAGE_CHANNEL],
		DataType out_img[OUT_IMAGE_SIZE * OUT_IMAGE_SIZE * FILTER_BATCH],
		DataType filter[FILTER_BATCH * FILTER_CHANNEL * FILTER_SIZE * FILTER_SIZE],
...
int main()
{
  ...
  //float *inp_image = (float *) malloc(input_vector_size_bytes);
	...
	int group =2;
    ifstream inp_file("/home/junnan/Vivado_HLS/conv2_full/out_padding1.txt");
    DataType *inp_image;
...
/*
	...
	ifstream filter_file("/home/junnan/Vivado_HLS/conv2_full/conv2Weights.txt");
	    DataType *filter;
	    filter = (DataType *)malloc( FILTER_BATCH*FILTER_CHANNEL*FILTER_SIZE*FILTER_SIZE * sizeof(DataType));
		...
		ifstream bias_file("/home/junnan/Vivado_HLS/conv2_full/conv2Bias.txt");
		    DataType *bias;
...
//  sds_free(inp_image);
  ...
  ofstream data("/home/junnan/Vivado_HLS/conv2_full/out_convolution2.txt");
