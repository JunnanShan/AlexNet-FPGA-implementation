...
int main()
{
    ...
    ifstream inp_file("/home/junnan/Vivado_HLS/Conv2/out_padding1.txt");
    DataType *inp_image;
	...
	ifstream filter_file("/home/junnan/Vivado_HLS/Conv2/conv2Weights.txt");
	    DataType *filter;
		...
		ifstream bias_file("/home/junnan/Vivado_HLS/Conv2/conv2Bias.txt");
		    DataType *bias;
  ...
  ofstream data("/home/junnan/Vivado_HLS/Conv2/out_convolution2.txt");
