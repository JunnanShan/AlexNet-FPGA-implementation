...
void pool5(DataType inp_img[INP_IMG_CHAN*INP_IMG_SIZE*INP_IMG_SIZE], DataType out_img[INP_IMG_CHAN*OUT_IMG_SIZE*OUT_IMG_SIZE]);

//main function used to test the functionality of the kernel.
int main()
{

    ifstream inp_file("/home/junnan/Vivado_HLS/Pool5/out_conv5.txt");
    DataType *inp_image;
  ...
  ofstream data("/home/junnan/Vivado_HLS/Pool5/out_image.txt");
