...
void conv4(DataType inp_img[INP_IMAGE_SIZE * INP_IMAGE_SIZE * INP_IMAGE_CHANNEL],
...
int main()
{
  ...
  //float *inp_image = (float *) malloc(input_vector_size_bytes);
	...
	//int group =2;
    ifstream inp_file("/home/junnan/Work/Vivado_HLS/conv4_tmp/inp_conv4.txt");
    DataType *inp_image;
...
/*
	...
	ifstream filter_file("/home/junnan/Work/Vivado_HLS/conv4_tmp/conv4Weights.txt");
	    DataType *filter;
		...
		ifstream bias_file("/home/junnan/Work/Vivado_HLS/conv4_tmp/conv4Bias.txt");
		    DataType *bias;
...
//  sds_free(inp_image);
  ...
  ofstream data("/home/junnan/Work/Vivado_HLS/conv4_tmp/out_image.txt");
